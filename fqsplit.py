...
#
#
# splits input fastq file into multiple smaller files of defined size.
# can be used to speed up alignment by running several processes in parallel.
...
def mod_fqsplit(sysargv):
	...
	parser = argparse.ArgumentParser(prog="methylCtools fqsplit", version="0.9.4", description="splits fastq file into multiple fastq files of defined size")
